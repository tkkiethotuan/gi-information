...
function hide_content() {
  var body_getter = document.querySelector(".content")
  body_getter.setAttribute("style", "display: none;")
  var nav_getter = document.querySelector(".offcanvas, .offcanvas-end")
  nav_getter.setAttribute("style", "width: 100%")
}

function show_content() {
  var body_getter = document.querySelector(".content")
  body_getter.setAttribute("style", "display: block;")
}